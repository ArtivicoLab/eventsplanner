...
// `vite preview` session on this same origin keeps serving its cached,
// cache-first assets — so `npm run dev` edits silently never show up no
// matter how many times the server restarts. In dev, tear any such worker +
// its caches down so the dev server is always the source of truth.

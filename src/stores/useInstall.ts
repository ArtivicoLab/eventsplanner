...
// standalone/iOS so chrome can guide users who don't get a native prompt
...
function detectPlatform(): InstallPlatform {
  ...
  // iPadOS 13+ Safari's default UA reports as desktop Macintosh; it's
  // distinguishable from a real Mac by touch support.
